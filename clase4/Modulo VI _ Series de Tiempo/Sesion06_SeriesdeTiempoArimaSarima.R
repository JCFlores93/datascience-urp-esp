...
# Capacitador: André Omar Chávez Panduro / Jose Cardenas Garro
...
# Ayuda a elegir el mejor ajuste ARIMA
...
# H0 indica que la seriees estacionaria
# Box y Pierce test
